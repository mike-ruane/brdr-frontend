...
{/if}
<h1>Help! <strong>Missing data for {species}</strong></h1>
...
<br/>
<br/>
<p><strong>Do you know/have</strong> access to some <strong>rich datasets of resident/migratory
  bird species</strong> in the <strong>British Isles?</strong></p>
<br/>
<br/>
...
<div class="message-brdr-form">
  <form action = "/species/{page}" method="POST">
    ...
    <textarea name="body" class="form-control" id="messageBrdr" rows="3"></textarea>
